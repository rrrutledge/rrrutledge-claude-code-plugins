...
- **Let the reply itself acknowledge their stated next step or a reported completed action.**
  ...
  **The same overreach rules out any closing add-on about the still-pending outcome** - a "let me know"/"no rush" reminder, or even a forward-looking well-wish like "hope you hear back soon": once they've stated they'll circle back, either kind re-surfaces the wait and implies the same doubt as restating their specifics; close on plain appreciation instead ("Really appreciate your help here.").
