...
- **Energizing close** — how to execute a warm close, when **Register** calls for one: end with a brief forward-looking note ("Looking forward to it!", "This'll be great") instead of a helper-offer tail.
  ...
  **Exception — confirming a commitment with nothing yet to report overrides the warm-register-holds-regardless line above.** When the reply's whole content is agreeing to a future action the other person just asked for ("will do"), skip both the forward-looking note and the offer-to-help tail, even in a warm sponsor/partner register — there's no landing moment to energize yet, just an acknowledged commitment. A single genuine personal-warmth line still closes it fine ("Always great working with you - thank you."); save the fuller close for once the thing itself actually happens.
