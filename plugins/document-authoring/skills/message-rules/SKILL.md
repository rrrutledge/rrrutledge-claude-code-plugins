...
- **Short acknowledgements stand alone** — "correct", "Sounds good!", "Great work", "Me too", "Will reschedule ✅", "Great news!".
  ...
  **Exception — they've just taken ownership of a nontrivial task or process, not answered a question or delivered a discrete favor:** pair the acknowledgment with the one real constraint shaping how they should carry it out (a hard time limit, a firm deadline). State it as orienting information, not a push to hurry — that's what keeps it substantive support rather than the barred follow-on concern.
