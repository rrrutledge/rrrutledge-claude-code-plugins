...
- **Keep asks open and tentative — don't pre-commit.**
  ...
  **Exception - the ask is to take on a concrete, fixed-scope deliverable (a talk, a defined task) rather than a negotiable amount or mechanism: give the time/format breakdown that defines the commitment** (a 5-minute welcome plus a 20-minute update, say), so the recipient can judge what they'd actually be agreeing to; that's distinct from a figure or process already settled between you, where restating would just belabor it.
...
- **Asking someone to confirm they can extend a commitment they already described: open by restating what they told you as plain fact.** "You said you're happy to X" carries the context without presuming a formal confirmation exchange, or paying them upfront for a commitment they haven't actually made yet. Close the same way: frame the ask as getting clear on what they're able to do, keep the release itself bare, and leave your own contingency plan out of it.
