...
- **A community-wide call for contributions** - in a community Slack workspace, closing on its custom brand emoji stacked with :rocket: (:isc: :rocket:) is in-voice, past both the palette and the one-emoji cap, but optional.
