...
- **The ISC workspace's custom :isc: emoji** - in the InnerSource Commons Slack, use it to generate excitement or mark a message as ISC-specific, past both the palette and the one-emoji cap, but optional (a community call for contributions is the worked case, and another emoji such as :rocket: can ride along).
