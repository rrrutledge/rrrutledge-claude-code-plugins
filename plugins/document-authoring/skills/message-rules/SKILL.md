...
- **First-touch outreach: keep the ask to one low-commitment thing, and warm the reference to their past work.**
  ...
  **Reconnecting after a long gap specifically to ask a favor that costs them real effort - meaningful time, their judgment, or their standing with someone else - gets a plain, brief acknowledgment of the imposition before the ask** — "Sorry to just write when I need a favor, but I wanted to ask something."
  **When the favor is a single quick action, a softened "One favor we need ..." lead-in carries that acknowledgment in place of the apology.**
...
- **Warm relationship gratitude** — to a sponsor, partner, community contributor, or someone Russell leads, thanking them for completed work or in advance on a favor ask — where Russell reaches for 🙏, ‼️, 👏, and 🎉 (often stacked, beyond the palette's one-emoji cap), usually on a closing thank-you ("Thank you 🙏‼️", "Sounds good 👏🎉‼️").
