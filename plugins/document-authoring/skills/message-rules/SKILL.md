...
- **A thank-you for a small favor is a name and an exclamation — nothing else.**
  ...
  **Exception — standing down an offer that ends up unused:** name what the thanks is for rather than bare name-only — "Thanks for being willing!" — since the bare form is for a favor actually rendered, and an offer that never got used still earns its own specific acknowledgment.
