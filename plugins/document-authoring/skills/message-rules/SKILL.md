...
- **Close nearly any ask, offer, or unsolicited handoff with an explicit no-pressure release** — "If not, then it's fine too - no problem." / "Either way is fine." — so saying no, or not using what you sent, costs the recipient nothing. This is a default habit, not special to money or a formal commitment.
  ...
  **Exception - a repeat nudge on a matter genuinely stalled with real external stakes** (a compliance filing, a third-party deadline) **states the stake plainly instead of releasing pressure** - "We really want to get this done with the FTB" carries the urgency; save the release for a favor or a lower-stakes ask.
