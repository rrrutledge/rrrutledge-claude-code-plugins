...
- **If you have options to resolve, pick the one you'd recommend and ask about that** — let the reader counter if they disagree.
  ...
  - **Exception - the ask is for them to organize or coordinate across several linked roles or slots.** Lay out the whole plan: what's already settled, and any named candidates for what's still open, so they have what they need to organize it, rather than collapsing it to a bare single-line ask. An unresolved "X or Y" for one of those slots is fine to leave open here, since deciding it is the coordinating work you're handing them, not a menu being put to them for their own choice.
