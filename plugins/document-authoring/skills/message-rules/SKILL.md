...
- **React to the specific thing they shared, and warm a rote close into genuine interest.**
  ...
  When a contact offers to refer you or get on a call, make both as easy to say yes to as possible in the same reply - attach your resume alongside the referral ask, and for a call, share your own scheduling link and ask whether a time on it works, rather than asking them to propose a time or send their own link.
