...
- **If you have options to resolve, pick the one you'd recommend and ask about that** — let the reader counter if they disagree.
  ...
  - **Exception - when someone else already raised or owns the idea, ask whether they still want to carry it through rather than unilaterally picking yourself.** Resolving the "or" to a single ask here would steamroll their initiative, so keep both live and let only a genuine timing crunch be grounds to offer yourself as the one to act instead.
