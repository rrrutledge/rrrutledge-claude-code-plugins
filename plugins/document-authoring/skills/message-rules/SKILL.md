...
- **When a review turns up several flaws, name only the one that actually blocks moving forward and call the rest good to go anyway.** Holding up otherwise-ready work over every observed flaw reads as gatekeeping.
