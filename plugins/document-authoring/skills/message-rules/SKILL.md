...
- **When the thing you're nudging on is stuck in the recipient's own internal process, a bare acknowledgment or reaction is enough on the first touch.**
  ...
  **Exception - a recruiter or similar contact actively courting Russell (Register's peer-from-first-touch case) skips the wait and gets a direct, warm status question on the first touch.**
  The pursuit runs the other way there, so asking outright - an opening thanks included - reads as confident engagement rather than chasing.
