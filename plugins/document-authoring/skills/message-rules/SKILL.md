...
This holds over email too, ahead of the email-keeps-its-greeting default in **Core voice**'s "1:1s often open with no greeting" bullet, which is for a professional/arms-length email thread, not a personal-friend one.
