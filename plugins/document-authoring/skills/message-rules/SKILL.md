...
- **A community-wide call for contributions in a community Slack workspace** - closing on the workspace's custom brand emoji stacked with :rocket: (for ISC, :isc: :rocket:) is in-voice there, past both the palette and the one-emoji cap, but optional, and it belongs to this conversational register rather than the formal no-emoji one.
