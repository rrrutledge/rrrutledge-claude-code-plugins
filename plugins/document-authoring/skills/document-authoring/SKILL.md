...
- **Reacting to a link, fact, or date the correspondent just handed you is restatement too when it re-describes their own content back to them.**
  Skip explaining what a link they shared covers or re-confirming a date they already gave; open on your reaction and refer to it with a short pointer ("the other one you flagged") rather than a recap.
