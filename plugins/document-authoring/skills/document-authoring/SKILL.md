...
- **On a sent deliverable, confirm receipt, not review, and release the timeline** — "did you get it? Look at it on whatever schedule works", not "did you get a chance to look at it?"
  The same receipt-check framing fits a favor someone else offered to carry out on your behalf (forwarding an intro, sending an email) when it's plausible they already did it and it just hasn't reached you — "I checked my spam but don't see anything from you yet - just checking that I haven't missed anything. If you're still working on it, that's fine too, at your leisure." Pair it with an explicit, separate release clause here — a receipt-check isn't chasing action, so the general ban on a tacked-on "no rush" clause above doesn't apply to it.
- **On unanswered outreach with no attachment and no reason to suspect they already acted, use a plain open prod with a "let me know" close** — "wanted to ask again about this. Let me know what you think." Don't use receipt-confirm framing here.
