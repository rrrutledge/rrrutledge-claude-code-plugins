...
- **Receiving unprompted praise for something you wrote or made: thank them back for the compliment itself, and credit AI lightly when it helped.** Lead with genuine thanks for the compliment before anything else, and when AI assisted in producing the praised work, name that plainly and briefly, with no elaboration or apology.
