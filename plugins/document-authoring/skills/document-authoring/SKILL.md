...
- **React to the specific thing they shared, and warm a rote close into genuine interest.**
  ...
  When a personal contact casually asks what you're looking for, answer at that same casual altitude with a plain category ("I'm in tech/software") rather than the fully leveled pitch (title tier, specialty acronyms) reserved for recruiter-facing or formal outreach.
