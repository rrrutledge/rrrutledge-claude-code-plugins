...
- **When the fresh reason is a gating condition that just cleared, phrase the ask as inviting the next step, not auditing whether it already happened.** "Is it time to file X now?" flags that the gate opened; "has X been filed?" reads as checking up on progress you have no way to see.
