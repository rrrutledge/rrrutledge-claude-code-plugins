...
- **Let the reply itself acknowledge their stated next step, a reported completed action, or a plan/conclusion they worked out themselves.**
  They've said what they'll do, that they already did it, or laid out a process and confirmed it themselves; restating the specifics back to them, even positively, adds pressure and implies they needed reminding — a generic "thanks for doing it" or a bare "Perfect" carries the acknowledgment without the recap.
