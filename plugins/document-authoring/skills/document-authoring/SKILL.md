...
Good news can brighten a close, but it modulates warmth *within* the relationship; it never overrides it.
Disappointing business news - a lead or prospect that won't pan out - gets light, matter-of-fact acceptance ("that's OK"), never expressed regret or sympathy over the lost opportunity: the warmth stays with the person, not poured onto the dead lead.
When two rules seem to conflict, this axis is the tiebreaker.
