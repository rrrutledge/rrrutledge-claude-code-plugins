...
- **When someone reports good news that resolves a constraint they raised earlier** (e.g. CEO approval despite a stated budget worry): credit their effort, not just the outcome — "Thank you for getting X" beats "Congrats on X" — and add a short separate line naming the earlier constraint and thanking them for persisting despite it ("Thank you for still supporting despite the challenging business environment").
