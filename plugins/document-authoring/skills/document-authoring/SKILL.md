...
- **Connecting two existing contacts to each other**: don't recite biographical facts about one to the other — two people already active in the same community likely already know who the other is. Ask instead whether they've already met, and let that open question carry the connection.
