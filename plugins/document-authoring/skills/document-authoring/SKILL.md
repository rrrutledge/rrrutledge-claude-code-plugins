...
- **Meet a reported problem with an unconfirmed cause, or someone's unexpected good news, with a genuine curious question — not an asserted conclusion or a flat close.**
  When someone reports a problem whose cause isn't actually confirmed, ask them what led to it rather than asserting a diagnosis — a screenshot or description is evidence, not proof, and a genuine "How did you get to that page?" reads as curious, not defensive, where a stated conclusion ("that page is misconfigured") can turn out wrong and commits you to it in writing.
  When someone shares unexpected good news or a flattering mention, a curious follow-up question ("How did this person find my article?") reads as more genuinely engaged than a closing thank-you that wraps the reply up right away.
