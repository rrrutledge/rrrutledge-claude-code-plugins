...
- **On unanswered outreach with no attachment, use a plain open prod with a "let me know" close** — "wanted to ask again about this. Let me know what you think." Don't use receipt-confirm framing here.
  **Exception — when the unanswered ask was a standing offer already on the table** (a scheduling link, a proposed slot) **rather than an open question, open warm instead and check whether the offer still stands** — "hope you're doing well. Let me know if this still works for you 👇" — pointing at the quoted offer below reads as an invitation, not a status check, so the receipt-confirm caution above doesn't apply to it.
