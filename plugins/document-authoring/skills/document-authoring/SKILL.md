...
- **When specific people own the answer, don't explain the architecture — route to them, or when the recipient is that owner, let them supply the mechanism.**
  ...
  Even when the expert asks you a direct factual question, answer only that - don't back your answer with an analysis of how their own system behaved, and don't volunteer how they should fix it; the diagnosis and the fix are theirs, and echoing their own stated insight back approvingly is padding.
