...
- **Reporting a completed task, stating what you'll do, sharing a recommendation, or answering a question you researched: lead with the outcome; cut the diagnostic play-by-play and the editorial wrap-up.**
  ...
  Don't append a confirm-or-next-step question or instruction ("sound right?", "OK to book it that way?", "keep pushing on the rest") about work that's routinely theirs to carry out - that closing belongs to the domain-expert case where you're genuinely putting a decision to them, not to a plain answer that already stands.
