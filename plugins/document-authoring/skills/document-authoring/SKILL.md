...
- **React to the specific thing they shared, and warm a rote close into genuine interest.**
  ...
  To a business or sponsor contact (not a close friend), reframe the reason positively — continued commitment plus openness to what's next — rather than naming the layoff itself; save that blunt disclosure for people you're personally close to.
