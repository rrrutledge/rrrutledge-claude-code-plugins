...
- **Partnering informally with a warm peer, keep the note to the direction and the relationship and leave compensation or terms to be settled live** - not a "what's fair for your time" or rate question in writing, but a note that the specifics will sort themselves out as you sync up and collaborate.
